...
class UI(QMainWindow):
    ...
    def intUI(self):
        ...
        RE =menu.addMenu('Rapid Execution')
...
#        Port.addAction(Port_Action)
        ...
        RE_Action =QAction("Rapid Execution",self)
        RE_Action.triggered.connect(self.execute)
        filemenu.addAction(Save_Action)
        filemenu.addAction(Close_Action)
        filemenu.addAction(Open_Action)
        RE.addAction(RE_Action)
